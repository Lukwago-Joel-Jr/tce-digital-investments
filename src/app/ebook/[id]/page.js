...
//           </div>
//         </div>
//         <div className="bg-white rounded-2xl shadow-lg max-w-4xl w-full flex flex-col md:flex-row overflow-hidden mt-10">
//           more details & info lets add all the the ifno .. the testimonials the
//           quotes .. etc
//         </div>
//       </div>
//     </div>
