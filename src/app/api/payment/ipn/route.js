...
async function sendEbookEmail(
  ...
  try {
    await createResend().emails.send({
      from: "WealthBuilderAcademy <no-reply@wealthbuildersacademy.com>",
      to: email,
    ...
    <!-- Email Body Container with Padding -->
    <div style="padding: 20px 30px;">
        <h2 style="color: #16a34a; font-size: 28px; margin-top: 0; margin-bottom: 10px; font-weight: bold;">
            ✨ Success! Your eBook Awaits! 🚀
        </h2>
    ...
    <div style="padding: 20px 30px;">
        <p style="color: #374151; font-size: 16px;">
            Your exclusive copy of <strong>${productTitle}</strong> is ready and attached to this email as a PDF.
        </p>
        ...
        <ul style="line-height: 1.8; color: #4b5563; padding-left: 20px;">
            ...
            <li style="margin-bottom: 8px;">Read one section at a time — and <strong>take action</strong> as you go. 🧠</li>
            <li>
        ...
        <p style="color: #374151; font-size: 16px; margin-top: 25px;">
            You now hold the blueprint to create financial transformation. Remember — you don't need permission to start; you just need a plan and faith to act. This eBook gives you both. 💡
        </p>
        <p style="color: #374151; font-size: 16px;">
            I can't wait to see what you create and how your journey unfolds! 🌟
        </p>
    ...
    <div style="background-color: #f3f4f6; padding: 15px 30px; text-align: center; border-top: 1px solid #e5e7eb;">
        <p style="font-size: 12px; color: #6b7280; margin: 0;">
            If you have any questions, please contact us at <a href="mailto:info@tcedigitalinvestments.com" style="color: #16a34a; text-decoration: none;">info@tcedigitalinvestments.com</a>.
        </p>
    </div>
</div>
      `,
