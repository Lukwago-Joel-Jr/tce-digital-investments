...
export const HeroText = () => {
  ...
  return (
    ...
    >
      <motion.h1 variants={itemVariants} className="md:text-8xl text-4xl font-bold mb-4">
        Wealth Builder Coaching Program
      </motion.h1>

      <motion.p variants={itemVariants} className="text-lg text-gray-700 mb-6 text-left">
      ...
      <motion.p variants={itemVariants} className="text-md text-gray-600 mb-6 text-left">
