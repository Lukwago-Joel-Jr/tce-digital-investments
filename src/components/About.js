...
const AboutSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 md:py-30 overflow-hidden">
      <motion.div
        className="flex flex-col items-center justify-center px-20 mb-p-10 pt-10"
      ...
      <div className="flex flex-col md:flex-row justify-center items-center mb:mt-4 ">
        ...
        >
          <motion.div
            className="w-fill px-5 md:p-2 md:w-100 md:mb-0 mb-2"
      ...
      <motion.div
        className="flex flex-col items-center justify-center md:w-2/3 rounded-2xl shadow-1xl bg-white p-5 md:p-15 mb-5 gap-4 mt-18 md:mt-[-40px]"
        variants={fadeUpVariant}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: false, amount: 0.3 }}
