    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 py-10 ">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center mb:mt-4 ">
        ...
        <div className="flex flex-col">
          ...
          <div className="w-fill px-5 md:p-2 md:w-100 mb:m-2">
            <p>
              I am wife, mother, entrepreneur, and a Christian who accepted Jesus to be my personal
              LORD and Savior. I&apos;ve seen firsthand the power of financial literacy and the impact it can
              have on people&apos;s lives when God is put in first Place when running Business.
              Deuteronomy 8:18 Remember the LORD your God, for it is He who gives you the ability
              to produce wealth. I&apos;m excited to share my knowledge and insights in this Ebook on how
              I was able to grow 2m-200m in capital through money lending in a space of 3 years,
              and to help others build the financial confidence and security they deserve.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 ">
          <div className="">
            <p className="text-lg font-bold">
              I have a background in finance and a passion for helping low income earner women and
              men achieve financial success. With over years of experience in the industry,
              I&apos;ve worked with clients from all walks of life and understand the unique challenges
              faced by underrepresented communities. Through my work as a financial advisor and
              advocate, I strive to create more equitable access to financial education, resources,
              and generally better livelihood for all through creating generational wealth.
              I&apos;m thrilled to be the author of this Ebook, and to share my perspective and
